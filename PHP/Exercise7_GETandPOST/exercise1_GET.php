...
<body>
    ...
    <ul>
        ...
        <li>
            <a href="exercise2_GET.php?gambar=<?= $smartphone["gambar"]; ?>&nama=<?= $smartphone["nama"]; ?>&merek=<?= $smartphone["merek"]; ?>&chipset=<?= $smartphone["chipset"]; ?>&ram=<?= $smartphone["ram"]; ?>&harga=<?= $smartphone["harga"]; ?>"><?= $smartphone["nama"]; ?></a>
        </li>
        <?php endforeach; ?>
    </ul>
</body>
